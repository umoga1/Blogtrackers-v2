...
<div class="card noborder curved-card mb30 containeraddblog pt40 pb40 mt20">
<div class="createblogsection">
<h5 class="text-primary text-center mt20 mb20">Enter Blog's Name and URL</h5>
<form>
<div class="form-group">
<input class= "form-control offset-md-2 col-md-8 col-md-2 blogtitle pt10 pb10 mb20" placeholder="Enter Blog Name" />
</div>
<div class="form-group mt20">
<input class=" form-control offset-md-2 col-md-8 col-md-2 blogurl pt10 pb10" placeholder="Enter Blog URL" />
</div>
...
<div class="card noborder curved-card mb30 containerdropfile pt40 pb40 mt20">
